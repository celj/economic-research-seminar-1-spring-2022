...
``Economic theory formulates thoughts via {[}\ldots{]} \emph{models}''
which are nothing but an objective and simplistic way of storytelling
our reality. Nonetheless, formal mathematical language prevents anyone
not used to it from criticizing `advanced' economic claims.
